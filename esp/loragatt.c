/* 
 * Gatts avec un seul profile et dedans un seul service, Lora Tx dans ESP_GATTS_WRITE_EVT
 * 
 * menuconfig: ne pas oublier: 
 * (Top) → Component config → Bluetooth #Activer le Bluetooth!
 * (Top) → Component config → LoRa Configuration #Set les pins, cf spi/README.md
 * 
 * write char depuis bluez pour tests:
 * 
 * 
 * BDADDR=24:6F:28:7A:CD:BE #custom PCB
...
static const char *TAG = "LORAGATT";
...
#define TEST_DEVICE_NAME            "LORAGATT"
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_WRITE_EVT: {
        ...
        ESP_LOGI(TAG, "GATT_WRITE_EVT, lora packet sent...");
