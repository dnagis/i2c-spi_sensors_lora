/* 
 * Base: https://github.com/dnagis/esp32_gatts_stub
 * 
 * mixé avec read built in hall sensor (cf. esp_anemo_hall pour version sans gatt)
 * 
 * 
 */
...
static const char *TAG = "GATTVVNX";
...
static uint8_t data_to_send[] = {0xff,0xff,0xff};
...
//la partie lecture built in hall, et loop par unité de temps
